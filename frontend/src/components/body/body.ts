...
class MyElement extends ElementBase {
    ...
    private setupQuickProjectMenu() {
        ...
        button.addEventListener("click", (_) =>
            toggleClass(this.renderRoot as ShadowRoot, "quick-project-select"),
        );
    ...
    protected render() {
        ...
        const tasksPath = "/components/tasks" + suffix;
        const projectsPath = "/components/projects" + suffix;
        const recipiesPath = "/components/recipies" + suffix;
                    ...
                    <div id="quick-project-select" class="dropdown">
                        ...
                        <div class="dropdown-menu" id="quick-project-menu" role="menu">
                            <div class="dropdown-content">
                                <slot id="quick-project-slot" name="project-dropdown"
